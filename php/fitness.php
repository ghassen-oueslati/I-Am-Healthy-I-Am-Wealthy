...
<header>
 ...
 <div class="filtrage">
    <ul>
       ...
       <li class="list" data-filter="equi"><button>Equipements</button></li>
       <li class="list" data-filter="acc"><button> Accessories</button></li>
    </ul>
</div>
...
<div class="equipements">
 ...
 ?>
	...
	<div class="col-md-4 equipement">
		<form method="post" action="fitness.php?action=add&id= <?php echo $row["id"]; ?>">
      <div class="itemBox <?php echo $row["categoryS"]; ?>">
          <figure class="figure2">
              ...
              <figcaption>
                ...
                <a href="../html/Produit/<?php echo $row["read_more"]; ?>">Read  More</a>
 ...
 <form action="" class="form-cart">
        <div>
            ...
            <tr>
              ...
              <td><a href="fitness.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
            ...
            ?>
            <tr><td colspan=5 >  <a href="command.php" style ="text-decoration: none;background-color: var(--S); color: var(--b);padding: 5px 20px;border:none;cursor: pointer;"> Make Purchase</a></td></tr>
            </table>
        </div>
     </div>
 </form>
